...
class MY_Profiler {
	...
	public function run()
	{   
        $output = '<div id="codeigniter_profiler_btn" style="
...
"><span class="glyphicon glyphicon-align-justify"></span></div>';
		$output .= "<div id='codeigniter_profiler' style='clear:both;background-color:#fff;padding:10px;position: absolute;top: 0px;z-index: 9998;display: none;width:100%;'>";
		$fields_displayed = 0;
		...
		$output .= '</div>';
        $output.='<script>
            var codeigniter_profiler_btn = document.getElementById("codeigniter_profiler_btn"),
                codeigniter_profiler = document.getElementById("codeigniter_profiler");
            codeigniter_profiler_btn.onclick=function(){
                    codeigniter_profiler.style.display = (codeigniter_profiler.display = !codeigniter_profiler.display) ? "block" : "none";
